  ...
  return (
    <div ref={dropdownRef} style={{ position: 'relative' }}>
      ...
      {isOpen && (
        ...
        >
          {/* Header */}
          <div style={{ padding: '12px', borderBottom: '1px solid #3a3a3a' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              <h4 style={{ margin: 0, fontSize: '14px', fontWeight: '600', color: '#e0e0e0' }}>Chat History</h4>
              <button
                onClick={() => {
                  onNewSession();
                  setIsOpen(false);
            ...
            {loading ? (
              ...
              sessions.map((session) => (
                ...
                >
                  ...
                  {/* Metadata */}
                  <div style={{ fontSize: '11px', color: '#a0a0a0', display: 'flex', gap: '8px' }}>
          ...
          {/* Footer */}
          {sessions.length > 0 && (
            <div style={{ padding: '8px 12px', borderTop: '1px solid #3a3a3a', fontSize: '11px', color: '#a0a0a0', textAlign: 'center' }}>
