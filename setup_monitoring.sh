...
echo ""
echo "Next steps:"
echo "1. Start the app + monitoring stack (one command):"
...
echo ""
echo "3. Grafana's Prometheus datasource and dashboards are auto-provisioned."
echo "   (To add community dashboards, e.g. ID 9628 for PostgreSQL, use Dashboards > Import.)"
echo ""
echo "4. Verify the backend metrics endpoint:"
